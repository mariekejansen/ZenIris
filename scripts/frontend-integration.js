 ...
 * This file demonstrates how to integrate Zeniris with a web frontend
 */

// For React/Vue/Angular applications
export class ZenirisClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ZenirisClient(provider, contractAddress);
